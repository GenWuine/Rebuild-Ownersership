        ...
        <ul className="space-y-2 font-medium">
          <li>
            ...
            >
              ...
              <span className="flex-1 ml-3 whitespace-nowrap">ModelGen</span>
            </Link>
          </li>
          <li>
            <Link
            ...
            >
              ...
              <span className="flex-1 ml-3 whitespace-nowrap">ImageAdGen</span>
            </Link>
          </li>
          <li>
            <Link
            ...
            >
              ...
              <span className="flex-1 ml-3 whitespace-nowrap">VideoAdGen</span>
            </Link>
          </li>
          <li>
            <Link
            ...
            >
              ...
              <span className="flex-1 ml-3 whitespace-nowrap">Models</span>
            </Link>
          </li>
          <li>
          <Link
